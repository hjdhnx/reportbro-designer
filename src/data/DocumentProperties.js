...
export default class DocumentProperties {
    ...
    getPageSize(originalPageFormat) {
        ...
        if (this.pageFormat === DocumentProperties.pageFormat.A4) {
        ...
        } else if (this.pageFormat === DocumentProperties.pageFormat.item) {
            if (this.orientation === DocumentProperties.orientation.portrait) {
                pageWidth = 30;
                pageHeight = 40;
            } else {
            ...
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.usLetter) {
            if (this.orientation === DocumentProperties.orientation.portrait) {
                pageWidth = 215.9;
                pageHeight = 279.4;
            } else {
            ...
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.usBatchDeposit) {
            if (this.orientation === DocumentProperties.orientation.portrait) {
                pageWidth = 215.9;
                pageHeight = 279.4;
            } else {
            ...
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.surveyCertification) {
            if (this.orientation === DocumentProperties.orientation.landscape) {
                pageWidth = 297;
                pageHeight = 210;
            } else {
                pageWidth = 210;
            ...
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.badge) {
            if (this.orientation === DocumentProperties.orientation.portrait) {
                pageWidth = 210;
                pageHeight = 297;
            } else {
            ...
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.resume) {
            if (this.orientation === DocumentProperties.orientation.portrait) {
                pageWidth = 210;
                pageHeight = 297;
            } else {
            ...
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.a4LabelSheet) {
            if (this.orientation === DocumentProperties.orientation.portrait) {
                pageWidth = 210;
                pageHeight = 297;
            } else {
            ...
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.dymoLabelSheet) {
            pageWidth = 0;
            pageHeight = 0;
            unit = DocumentProperties.unit.mm;
        } else if (this.pageFormat === DocumentProperties.pageFormat.a4Statement) {
            if (this.orientation === DocumentProperties.orientation.portrait) {
                pageWidth = 210;
                pageHeight = 297;
            } else {
...
DocumentProperties.pageFormat = {
    ...
    A5: 'A5',
    letter: 'letter',
    item: 'item', // 物品纸张 40mm x 30mm
    usLetter: 'usLetter',
    usBatchDeposit: 'usBatchDeposit',
    surveyCertification: 'surveyCertification',
    badge: 'badge',
    resume: 'resume',
    a4LabelSheet: 'a4LabelSheet',
    dymoLabelSheet: 'dymoLabelSheet',
    a4Statement: 'a4Statement',
