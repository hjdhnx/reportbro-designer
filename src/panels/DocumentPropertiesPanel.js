...
export default class DocumentPropertiesPanel extends PanelBase {
    ...
    render(data) {
        ...
        elPageFormat.append(utils.createElement('option', { value: 'item' }, this.rb.getLabel('pageFormatItem')));
        elPageFormat.append(utils.createElement('option', { value: 'usLetter' }, this.rb.getLabel('pageFormatUsLetter')));
        elPageFormat.append(utils.createElement('option', { value: 'usBatchDeposit' }, this.rb.getLabel('pageFormatUsBatchDeposit')));
        elPageFormat.append(utils.createElement('option', { value: 'surveyCertification' }, this.rb.getLabel('pageFormatSurveyCertification')));
        elPageFormat.append(utils.createElement('option', { value: 'badge' }, this.rb.getLabel('pageFormatBadge')));
        elPageFormat.append(utils.createElement('option', { value: 'resume' }, this.rb.getLabel('pageFormatResume')));
        elPageFormat.append(utils.createElement('option', { value: 'a4LabelSheet' }, this.rb.getLabel('pageFormatA4LabelSheet')));
        elPageFormat.append(utils.createElement('option', { value: 'dymoLabelSheet' }, this.rb.getLabel('pageFormatDymoLabelSheet')));
        elPageFormat.append(utils.createElement('option', { value: 'a4Statement' }, this.rb.getLabel('pageFormatA4Statement')));
        elPageFormat.append(utils.createElement('option', { value: 'user_defined' }, this.rb.getLabel('pageFormatUserDefined')));
